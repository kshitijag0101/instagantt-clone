...
export default function SignUp() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await HandleRegister(fullname, email, password, repeatpassword, router);
    };
        ...
        !isLoggedIn && (
            <div className="h-screen bg-[url('/img/hero.jpg')] bg-cover flex items-center justify-center">
                <div className="bg-white w-1/3 px-12 m-auto rounded-md">
                    ...
                    <label htmlFor="Email" className="text-[#61657d] text-sm">
                        Email
                    </label>
                    <input
                        type="text"
                    ...
                    {isContinue ? (
                        ...
                        <div className="text-center pb-6">
                            ...
                            <Link href="/login" className="text-[#0088cc]">
